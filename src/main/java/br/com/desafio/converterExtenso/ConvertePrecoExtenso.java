package br.com.desafio.converterExtenso;
...
public class ConvertePrecoExtenso {
	...
	public ConvertePrecoExtenso() {
		nro = new ArrayList();
	}

	public ConvertePrecoExtenso(BigDecimal dec) {
		this();
		setNumber(dec);
	}

	public ConvertePrecoExtenso(double dec) {
		this();
		setNumber(dec);
	}
